  ...
  return (
    <>
      <div  onClick={handelmenu} className="relative z-[100] p-[5px] cursor-pointer border  rounded-lg">
        ...
        <div style={menufor} className='absolute  md:right-2 lg:left-2 font-[500] gap-2  -bottom-[120px] p-1 text-lg text-left border py-2 px-2  flex-col items-start   rounded-sm w-[100px] bg-[white] text-black'  >
