  ...
  const handeldelete = (id) =>{
    ...
    .then((res) =>{console.log(res)
      if (res.data.status === 'success'){
        ...
        setProfile('Receptionist not found')
      }
  ...
  return (
    <div>
      ...
      <div className='p-8 border rounded-xl  mt-6 flex flex-wrap container mx-auto justify-between items-center '>
        ...
        <button onClick={()=>navi('/receptionist/add')} className='p-2 px-8 hover:opacity-80 text-white bg-gg rounded-3xl font-semibold text-lg' >Add</button>
