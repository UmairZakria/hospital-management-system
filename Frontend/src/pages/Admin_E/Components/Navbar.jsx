        ...
        <div className='relative z-[100]'>
          ...
          <button onClick={handelmenu} className='w-10 h-10 lg:hidden md:hidden' ><img src={menuico} width={25} height={25} className='active:rotate-180 duration-75 transition-all ease-in'  alt="Menu Icon " /></button>
                ...
                <div className='hidden md:flex lg:flex gap-6  items-center justify-center'>
                    ...
                    <NavLink to='/doctors' className={(e) => { return e.isActive ? 'border-b-2 pb-1' : 'pb-1 hover:scale-110  transition-all ease-in' }}>
                    ...
                    <NavLink to='/department' className={(e) => { return e.isActive ? 'border-b-2' : 'hover:animate-pulse transition-all ease-in' }}>
                    ...
                    <NavLink to='/setting' className={(e) => { return e.isActive ? 'border-b-2' : 'hover:rotate-[44deg] active:rotate-[24deg] transition-all ease-in' }}>
            ...
            <div style={profile1} className='w-full lg:hidden md:hidden text-white bg-gg transition-all duration-500 ease-in-out absolute  top-[100%] left-0 flex-col z-10 rounded-b-lg'>
                ...
                <NavLink to='/doctors' className='px-5 flex py-4 w-full bg-gg hover:bg-[#0098ac]' >Doctors </NavLink>
                <NavLink to='/department' className='px-5 flex py-4 w-full bg-gg hover:bg-[#0098ac]' >Departments </NavLink>
